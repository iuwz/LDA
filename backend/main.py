...
from backend.app.mvc.views.analysis import router as analysis_router  # <— register analysis routes
...
def create_app() -> FastAPI:
    ...
    app.include_router(analysis_router)  # <— mounts all /risk endpoints
    ...
    # (Optional) legacy risk endpoints can remain if you still need file-based analysis:

...
const teamMembers = [
  {
    ...
    bio: "Merges AI capabilities with robust full-stack development to create intelligent, end-to-end digital solutions.",
    avatarUrl: Mazen,
  ...
  },
  {
    ...
    role: "Full-Stack Engineer",
    bio: "Back-end expert with a full-stack mindset—crafting APIs, databases, and systems that power real-world apps.",
    avatarUrl: Abdulaziz,

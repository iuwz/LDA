/* ────────────────────────────────────────────────────────────────
   ...
   ‣ New Privacy Policy page (public).
   ‣ Matches LDA brand: serif headings, gradient accents, warm-beige backgrounds,
     Tailwind utilities, Framer-Motion reveals, and Bubble background.
────────────────────────────────────────────────────────────────── */
...
import aboutHero from "../../../assets/images/about-hero.jpeg"; // reuse hero
  ...
  return (
    <main className="font-sans text-gray-800 bg-white">
      ...
      <Hero
        ...
        subtitle="Your trust matters. Here’s exactly how we safeguard your data."
        ctaText="Read below ↓"
        ctaLink="#policy"
        bgImage={aboutHero}
      />
